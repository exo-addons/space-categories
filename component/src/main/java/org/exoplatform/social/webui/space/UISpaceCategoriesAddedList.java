 ...
 * minh.dang@exoplatform.com Oct 18, 2006 2:28:18 PM
 */
@ComponentConfig(template = "war:groovy/social/webui/space/UISpaceCategoriesAddedList.gtmpl", events = {
...
public class UISpaceCategoriesAddedList extends UIContainer implements UISelectable {
  ...
  public void init() throws Exception {
    LazyPageList<Object> objPageList = new LazyPageList<Object>((ListAccess<Object>) new ListAccessImpl<Object>(Object.class,
                                                                                                                getListCategories()),
                                                                10);
  ...
  public void doSelect(String selectField, Object value) throws Exception {
    ...
    try {
      ...
      throw new MessageException(new ApplicationMessage("AccessControlException.msg", null, ApplicationMessage.WARNING));
  ...
  static public class DeleteActionListener extends EventListener<UISpaceCategoriesAddedList> {
    public void execute(Event<UISpaceCategoriesAddedList> event) throws Exception {
      ...
      Node currentNode = uiSpaceCategory.getCurrentNode();
      TaxonomyService taxonomyService = uiAddedList.getApplicationComponent(TaxonomyService.class);
